package com.ccc.search.service.impl;
...
import com.ccc.search.constant.EsConstant;
import com.ccc.search.feign.ProductFeignService;
import com.ccc.search.service.MallSearchService;
import com.ccc.search.vo.AttrResponseVo;
import com.ccc.search.vo.BrandVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    private SearchResult buildSearchResult(SearchResponse response, SearchParam param) {
        ...
        List<SkuEsModel> esMOdes = new ArrayList<>();
        ...
        if (param.getAttrs() != null && param.getAttrs().size() > 0) {
            List<SearchResult.NavVo> collect = param.getAttrs().stream().map(attr -> {
                ...
                //取消了这个面包屑以后，我们要跳转到那个地方，将请求地址的url里面的属性置空
                //拿到所有的查询条件，去掉当前
